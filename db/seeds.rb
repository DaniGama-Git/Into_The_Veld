...
# Creating Cars
Car.create(title: 'Rugged Beast', description: 'Conquer any terrain with this powerful 4x4.', price: 9999.99, available: true, make: 'Land Rover', model: 'Range Rover', accomodation: true, cooking: true, seats: 5, consumption: 15, user_id: User.all.sample.id)
Car.create(title: 'Off-Road King', description: 'Unleash the adventurer in you with this off-road powerhouse.', price: 6499.99, available: true, make: 'Jeep', model: 'Wrangler', accomodation: false, cooking: false, seats: 4, consumption: 20, user_id: User.all.sample.id)
Car.create(title: 'Mountain Explorer', description: 'Experience the thrill of exploring mountains with this reliable 4x4.', price: 5699.99, available: true, make: 'Toyota', model: '4Runner', accomodation: true, cooking: false, seats: 5, consumption: 18, user_id: User.all.sample.id)
Car.create(title: 'Wilderness Voyager', description: 'Embark on unforgettable wilderness adventures with this rugged vehicle.', price: 7399.99, available: true, make: 'Ford', model: 'F-150 Raptor', accomodation: true, cooking: true, seats: 4, consumption: 14, user_id: User.all.sample.id)
